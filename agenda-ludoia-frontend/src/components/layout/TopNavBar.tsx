      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        <div className="flex items-center gap-3 hover:bg-primary/5 p-1.5 rounded-full transition-colors cursor-pointer pr-3">
          ...
          <div className="text-left hidden sm:block">
            <p className="text-xs font-bold text-on-surface leading-tight">Dra. Sarah Jenkins</p>
            <p className="text-[11px] text-on-surface-variant font-medium">Fisioterapeuta Sede Central</p>
          </div>
        </div>
      </div>
    </header>
